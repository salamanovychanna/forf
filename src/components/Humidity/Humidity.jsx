    ...
    return (
        <div style={{maxWidth: '1080px', width: '100%'}}>
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems:'center'}}>
                ...
                <span style={{fontSize: '96px', fontFamily: '"Orbitron", sans-serif'}}>70%</span>
                <p style={{width: '400px'}}>*When humidity is over 65% it means it is on its the highest level. At this time lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget vestibulum neque, id venenatis lorem. Aenean faucibus nibh vitae tempus cursus.read about humadity on tips page</p>
